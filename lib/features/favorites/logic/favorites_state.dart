...
class FavoritesState with _$FavoritesState {
  ...
  const factory FavoritesState.successGetFavorites(FavoritesResponse data) =
      SuccessGetFavorites;

  const factory FavoritesState.loadingAddFavorites() = LoadingAddFavorites;

  const factory FavoritesState.successAddFavorites(FavoritesAddResponse data) =
      SuccessAddFavorites;
