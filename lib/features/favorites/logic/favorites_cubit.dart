...
class FavoritesCubit extends Cubit<FavoritesState> {
  ...
  FavoritesCubit(this._favoritesRepo,this._homeCubit) : super(const FavoritesState.initial());
  ...
  void emitAddFavorites(FavoritesRequest id) async {
    ...
    response.whenOrNull(success: (favoritesAddResponse) {
      ...
      debugPrint(_homeCubit.favorites.toString());
      debugPrint('111111111111111111111111111111');
